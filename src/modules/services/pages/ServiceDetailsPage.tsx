...
import { serviceDetails } from "@/modules/services/data/servcieDetails";
  ...
  return (
    <>
      ...
      <section className="container-px max-w-[1320px] mx-auto pt-28 md:pt-36">
        ...
        <h1 className="mt-[24px] text-[30px] md:text-[44px] md:leading-[52px] leading-[38px] lg:text-[64px] lg:leading-[72px] xl:text-[80px] xl:leading-[88px] font-medium font-sans text-[#111514] max-w-full tracking-tight">
          {s.title}
        </h1>
        ...
        <div className="mt-8 md:mt-12 bg-[#eff0eb] rounded-[20px] xl:rounded-[46px] p-2 sm:p-3 md:p-4 mb-10 md:mb-16">
          <div className="bg-[#fefffa] rounded-[16px] xl:rounded-[36px] p-4 sm:p-6 md:p-6 xl:p-6">
            <Img
              ...
              alt={s.title}
              ratio="16/8"
              className="rounded-[16px] xl:rounded-[24px] w-full mb-8 xl:mb-12 object-cover"
            />
            <div className="flex flex-col xl:flex-row gap-8 xl:gap-12 items-start justify-between">
              <article className="w-full xl:w-[67%]">
                ...
                <p className="text-[16px] md:text-[18px] leading-[24px] font-normal font-sans text-[#4c4d4d] mb-8">
                  Share your symptoms to find out if this care approach is suitable for your needs.
                </p>

                <h2 className="text-[24px] md:text-[32px] leading-[32px] md:leading-[40px] font-medium font-sans text-[#111514] mb-4">
                  Disclaimer
                </h2>
                <p className="text-[16px] md:text-[18px] leading-[24px] font-normal font-sans text-[#4c4d4d]">
              ...
              <aside className="w-full xl:w-[33%] xl:sticky xl:top-32 hidden xl:flex flex-col gap-4">
                <div className="bg-[#f4f5f0] rounded-[24px] p-6">
                  <div className="text-[24px] leading-[34px] font-medium font-sans text-[#111514] mb-4">
                    More services
                  </div>
                  <div className="grid grid-cols-1 gap-4">
                    {others.map((o) => (
                      <Link
                        key={o.slug}
                        to={`/services/${o.slug}`}
                        className="group flex flex-col gap-3 bg-[#fefffa] rounded-[16px] p-3 border border-black/4 hover:shadow-sm transition"
                      >
                        <Img
                          src={`/images/services/services-${parseInt(o.number)}.webp`}
                          alt={o.title}
                          ratio="16/11"
                          className="rounded-[12px] w-full object-cover"
                        />
                        <div className="text-[20px] leading-[28px] font-medium text-[#111514] font-sans group-hover:text-[#1F9B6A] transition-colors">
                          {o.title}
                        </div>
                      </Link>
                    ))}
        ...
        <div className="xl:hidden mb-16">
          <div className="bg-[#f4f5f0] rounded-[20px] md:rounded-[24px] p-3 md:p-4 lg:p-6">
            <div className="text-[20px] md:text-[24px] leading-[24px] md:leading-[34px] font-medium font-sans text-[#111514] mb-3 md:mb-4 lg:mb-6">
              More services
            </div>
              ...
              {others.map((o) => (
                ...
                >
                  <Img
                    ...
                    className="rounded-[12px] w-full object-cover"
                  />
                  <div className="text-[16px] md:text-[20px] leading-[20px] md:leading-[28px] font-medium text-[#111514] font-sans group-hover:text-[#1F9B6A] transition-colors">
                    {o.title}
                  </div>
                </Link>
              ))}
