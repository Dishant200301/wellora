    ...
    <section className="container mx-auto px-4 py-20 pt-32 xl:pt-32 xl:pb-20">
      <div className="max-w-[1240px] mx-auto">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-2 text-[28px] md:text-[44.3px] leading-[36px] md:leading-[56px] font-medium text-[#111514] max-w-[520px] mx-auto">
            Neurology Insights &amp; Brain Health
          </h2>
        </div>
        ...
        <div className="bg-[#EFF0EB] rounded-[20px] p-4">
          <div className="grid lg:grid-cols-3 gap-4">
            ...
            >
              ...
              >
                <Img
                  src={sectionArticles[0].image}
                  fallbackSrc={`/images/articles/${sectionArticles[0].slug}.jpg`}
              ...
              >
                <AnimatePresence initial={false}>
                  {hoveredIndex !== 0 && (
                    ...
                    >
                      <div className="text-md leading-[24px] text-[#4C4D4D]">
                        {sectionArticles[0].date}
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                <AnimatePresence initial={false}>
                  {hoveredIndex !== 0 && (
                    <motion.div
                      ...
                      className="pointer-events-auto overflow-hidden shrink-0"
                    >
                      <p className="text-md leading-[24px] text-[#4C4D4D] line-clamp-2">
            ...
            >
              <div className="absolute inset-0 overflow-hidden">
                <Img
                  src={sectionArticles[1].image}
                  fallbackSrc={`/images/articles/${sectionArticles[1].slug}.jpg`}
              ...
              <div className="absolute bottom-6 left-4 md:left-6 right-4 text-white z-10 pointer-events-none">
                <h3 className="text-[20px] leading-[24px] md:text-[22.1px] md:leading-[34px] font-medium line-clamp-3">
            ...
            >
              ...
              >
                <Img
                  src={sectionArticles[2].image}
                  fallbackSrc={`/images/articles/${sectionArticles[2].slug}.jpg`}
                ...
                <AnimatePresence initial={false}>
                  {hoveredIndex !== 2 && (
                    <motion.div
                      ...
                      className="pointer-events-auto overflow-hidden shrink-0"
                    >
                      <div className="text-sm leading-[20px] md:text-md md:leading-[24px] text-[#4C4D4D]">
                        {sectionArticles[2].date}
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
