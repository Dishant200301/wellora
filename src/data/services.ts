...
export const services: Service[] = [
  {
    ...
    evaluation: [
      "Detailed history and symptom diary",
      "Neurological exam",
    ...
    treatment: [
      ...
      "CGRP-targeted therapies when appropriate",
    ...
    expect: [
      ...
      "Clear plan for breakthrough pain",
      "Ongoing monitoring",
  ...
  },
  {
    ...
    overview:
      "Comprehensive epilepsy care from diagnosis through long-term medication management and lifestyle planning.",
    symptoms: [
      "Loss of awareness",
  ...
  },
  {
    ...
    evaluation: [
      ...
      "Detailed history including family",
    ...
    treatment: [
      ...
      "Coordination with allied care",
    ],
    expect: [
      "Clear diagnosis or monitoring plan",
      "Better day-to-day strategies",
