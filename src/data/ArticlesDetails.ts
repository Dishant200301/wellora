...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Sign memory tips",
        body: "Regularly checking for warning signs enables you to react promptly and efficiently. This proactive approach can significantly improve the chances of a successful recovery and minimize long-term impact on your daily life.",
      },
      {
      ...
      {
        heading: "Check for symptoms",
        body: "Taking swift action and making the right choices can significantly impact the results. The decisions we make in the present can lead to very different outcomes in the future, shaping our path and the possibilities that lie ahead.",
      },
      {
      ...
      {
        heading: "When to speak to a doctor",
        body: "While not every symptom indicates a medical emergency, it's important to be aware of what is normal for your body. Early detection often leads to more effective treatment, so stay vigilant and proactive about your health.",
      },
      {
        heading: "Ongoing or unclear symptoms",
        bullets: [
          "If you notice any abnormal symptoms",
          "If you notice a decrease in your memory",
          "If you frequently develop high blood pressure",
          "If you worry daily about your symptoms",
        ],
      },
      {
