...
export default function CaseStudies() {
  return (
    <>
      <SEO
        title="Case Studies"
        description="Real results from real neurological care — outcomes from Dr. Wellora's practice."
        path="/case-studies"
      />
      ...
      <section className="container-px max-w-7xl mx-auto mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6 mb-24">
        {caseStudies.map((c, index) => (
          ...
          >
            <Img
              src={`/images/case-studies/case-studies-${(index % 5) + 1}.webp`}
              alt={c.title}
              ratio="16/11"
      ...
      <BookingForm heading="Schedule a consultation with Dr. Wellora for expert diagnosis." />
    </>
  );
}
