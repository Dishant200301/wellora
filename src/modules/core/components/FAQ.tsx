...
import { faqCategories } from "@/modules/core/data/faq";
    ...
    <section className="container mx-auto px-4 py-12">
      <div className="max-w-[750px] mx-auto">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-2 text-[30px] md:text-[32px] lg:text-[44.8px] leading-[36px] md:leading-[40px] lg:leading-[56px] font-medium text-[#111514] max-w-[520px] mx-auto">
                  ...
                  <li key={it.q} className="bg-[#FEFFFA] rounded-[16px]">
                    <motion.div layout className="overflow-hidden">
                      <button
                        ...
                        className="cursor-pointer w-full text-left flex items-center justify-between gap-4 px-4 py-4 md:px-6 md:py-5"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-full bg-[#F1F3E8] flex items-center justify-center">
                            <div
                              className={`relative w-3 h-3 transition-transform duration-300 ${isOpen ? "-rotate-[45deg]" : ""}`}
                            >
                          ...
                          <span className="text-[16px] leading-[24px] md:text-[18px] md:leading-[28px] font-medium text-[#111514]">
                            {it.q}
                          </span>
                        </div>
                      </button>
