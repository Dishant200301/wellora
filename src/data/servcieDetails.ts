...
export const serviceDetails: ServiceDetail[] = [
  {
    ...
    offers: ["Personalized Treatment", "Special Care", "Diagnostic Support", "Trigger Management", "Follow-Up", "Neuro Assessment"],
    ...
    symptoms: {
      intro: "You may experience one or more of the following symptoms. Proper evaluation helps define the type of headache:",
      items: [
    ...
    causes: {
      intro: "Headaches and migraines are triggered by various genetic, environmental, and physiological factors:",
      items: [
    ...
    evaluation: {
      intro: "Our diagnostic approach targets finding the root causes and establishing trigger patterns:",
      items: [
    ...
    expect: {
      intro: "A collaborative care plan helps patients achieve long-term control over their symptoms:",
      items: [
  ...
  },
  {
    ...
    symptoms: {
      intro: "Neuropathy symptoms often start gradually and may vary depending on the nerves affected:",
      items: [
    ...
    causes: {
      intro: "Nerve damage can result from systemic conditions, trauma, toxins, or inherited factors:",
      items: [
    ...
    evaluation: {
      intro: "Evaluating nerve damage involves specialized neurological tests to determine the extent of neuropathy:",
      items: [
    ...
    expect: {
      intro: "With structured management, most patients can expect significant symptom control and recovery:",
      items: [
  ...
  },
  {
    ...
    overview: "Seizures & Epilepsy Care focuses on diagnosing, managing, and reducing the impact of seizure-related conditions. This service provides a structured, personalized approach to help control seizures, identify triggers, and improve daily functioning. The goal is long-term stability, safety, and a better quality of life.",
    symptoms: {
      intro: "You may experience one or more of the following signs. Early recognition is important for proper care:",
      items: [
    ...
    causes: {
      intro: "Seizures can occur due to different underlying factors. Identifying the cause helps guide treatment:",
      items: [
    ...
    evaluation: {
      intro: "Care starts with a detailed assessment to understand your condition and seizure patterns:",
      items: [
    ...
    expect: {
      intro: "Management focuses on controlling seizures and improving daily life over time. With proper care, many patients experience:",
      items: [
  ...
  },
  {
    ...
    causes: {
      intro: "Disruptions in brain circuitry or neurotransmitter levels are the primary causes of movement changes:",
      items: [
    ...
    expect: {
      intro: "Patients benefit from structural management targeted at sustaining functional independence:",
      items: [
  ...
  },
  {
    ...
    symptoms: {
      intro: "Memory and cognitive changes can display in various ways, affecting daily routines and thinking:",
      items: [
    ...
    causes: {
      intro: "Cognitive declines can be caused by reversible issues, age-related factors, or structural brain changes:",
      items: [
