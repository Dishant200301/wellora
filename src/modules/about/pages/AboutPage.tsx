...
export default function About() {
  ...
  return (
    <>
      <SEO
        title="About me"
        description="Patient-first neurology with accurate diagnosis, clear communication, and long-term care strategies."
        path="/about"
      />
      <section className="container-px max-w-[1320px] mx-auto pt-28 md:pt-36">
        <div className="relative w-full xl:h-[626px] bg-[#EFF0EB] rounded-[20px] p-4 flex flex-col xl:flex-row gap-4 items-center">
          ...
          <div className="w-full grow xl:h-[594px] bg-[#FEFFFA] rounded-[16px] p-6 md:p-8 xl:px-[32px] xl:py-[40px] flex flex-col relative">
            <div className="grow">
              <div className="mb-[24px] md:mb-[40px]">
                <div className="text-[15px] md:text-[16.6px] leading-[24px] md:leading-[28px] text-[#4C4D4D] font-normal font-sans">
                  Care Philosophy
                </div>
                <h1 className="mt-[4px] text-[24px] sm:text-[28px] md:text-[29.5px] leading-[32px] sm:leading-[38px] md:leading-[40px] font-medium text-[#111514] font-sans">
                  A mindful approach to brain care.
                </h1>
              </div>
              ...
              <div className="space-y-[20px] md:space-y-[28px]">
                <p className="text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-[#4C4D4D] font-sans">
                  I chose neurology for its link between brain and body. Early on, I met a patient
                  who felt misunderstood, shaping how I approach every consultation.
                </p>
                <p className="text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-[#4C4D4D] font-sans">
                  I prioritize listening in my practice to understand how your symptoms affect your
                  daily life. I provide clear explanations so you leave each visit knowing our
                  findings, their significance, and the next steps.
                </p>
                <p className="text-[16px] md:text-[18px] leading-[26px] md:leading-[28px] text-[#4C4D4D] font-sans">
                  This practice stands out for its clear and steady approach to care. I take my time
                  with decisions and eliminate unnecessary steps, aiming to provide structured, calm
                  care rooted in genuine understanding.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-[1520px] mx-auto px-3 md:px-4">
          <div className="bg-[#262626] rounded-[32px] p-5 md:p-[20px] lg:p-[40px] xl:p-[80px] flex flex-col items-center">
            <div className="text-center mb-[40px] md:mb-[80px]">
              <div className="text-[16.3px] leading-[28px] text-[#CDCDCD] font-normal font-sans">
            ...
            <div className="w-full bg-[#2E2D2D] rounded-[20px] p-1.5 md:p-[16px] grid xl:grid-cols-2 gap-4 md:gap-[16px]">
              ...
              <div className="bg-[#1C1C1C] rounded-[20px] p-4 md:p-[32px]">
                <div className="mb-[32px]">
                  <h3 className="text-[22.3px] leading-[34px] font-medium text-white font-sans">
                    Education
                  </h3>
                  <p className="mt-[22.5px] text-[16.5px] leading-[28px] text-[#CDCDCD] font-sans">
                    A strong foundation of education, continuous training, and recognized
                ...
                <div className="space-y-[40px] mt-[40px]">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div>
                      <h4 className="text-[18.4px] leading-[28px] font-medium text-white font-sans">
                        Doctor of Medicine (MD)
                      </h4>
                      <div className="text-[16.3px] leading-[28px] text-[#CDCDCD] font-normal font-sans mt-[4px]">
                        Specialization in Neurology
                      </div>
                      <p className="text-[16.6px] leading-[28px] text-[#CDCDCD] font-sans mt-[15px]">
                        Completed advanced medical training with a focus on brain and nervous system
                        disorders.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[16.6px] leading-[28px] text-[#CDCDCD] font-sans mt-[15px]">
                        Comprehensive clinical training in diagnosis and treatment of neurological
                        conditions.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div>
                      <h4 className="text-[18.6px] leading-[28px] font-medium text-white font-sans">
                        Clinical Fellowship
                      </h4>
                      <p className="text-[16.6px] leading-[28px] text-[#CDCDCD] font-sans mt-[15px]">
              ...
              <div className="p-3 md:p-[32px]">
                <div className="mb-[32px]">
                  <h3 className="text-[22.1px] leading-[34px] font-medium text-white font-sans">
                ...
                <div className="space-y-[28px] mt-[40px]">
                  {[
                    ...
                    <div
                      key={award}
                      className={`flex items-center gap-6 pb-[20px] md:pb-[28px] ${index !== 3 ? "border-b border-[#424242]" : ""}`}
                    >
                      ...
                      <h4 className="text-[18px] leading-[28px] font-medium text-white font-sans">
                        {award}
                      </h4>
                    </div>
                  ))}
      ...
      <section className="container-px max-w-[1320px] mx-auto py-[100px]">
        <div className="mb-[40px] md:mb-[80px]">
          <div className="text-[17.4px] leading-[28px] text-[#4C4D4D] font-normal font-sans text-left">
            Training
          </div>
        ...
        <div className="bg-[#EFF0EB] rounded-[20px] p-[16px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xl:hidden mb-[16px]">
            {affiliations.map((item, index) => (
              <div key={index} className="bg-[#FEFFFA] rounded-[16px] p-3 flex flex-col gap-4">
            ...
            {affiliations.map((item, index) => (
              ...
              >
                ...
                <div className="cursor-pointer flex flex-row items-center w-full px-[24px] transition-all duration-500 ease-in-out">
                  <div
                    className={`w-[40%] text-[22.3px] font-medium transition-all duration-500 ease-in-out
                    ${hoveredIndex === index ? "text-white pl-[128px]" : "text-[#111514] pl-0"}`}
                  >
                    {item.title}
                  </div>
                  <div
                    className={`w-[20%] text-center text-[22.1px] font-medium transition-colors duration-500
                    ${hoveredIndex === index ? "text-white" : "text-[#111514]"}`}
                  >
                    {item.period}
                  </div>
                  <div
                    className={`w-[40%] text-right text-[22.3px] font-medium transition-colors duration-500
                    ${hoveredIndex === index ? "text-white" : "text-[#111514]"}`}
                  >
                    {item.role}
                  </div>
          ...
          <div className="bg-[#FEFFFA] rounded-[16px] p-6 md:p-[24px] flex flex-col lg:flex-row justify-between items-center gap-8">
            <div className="space-y-[14px] text-center lg:text-left w-full lg:w-auto">
              <div>
                ...
                <div className="text-[21.9px] leading-[34px] font-medium text-[#111514]">
                  12345678901
                </div>
              </div>
      ...
      <section className="container-px max-w-[1320px] mx-auto py-[60px] md:py-[80px] xl:py-[100px]">
        <div className="text-center mb-[40px] md:mb-[60px] xl:mb-[80px]">
          <div className="text-[16.7px] leading-[28px] text-[#4C4D4D] font-normal font-sans">
            My Approach
          </div>
        ...
        <div className="bg-[#EFF0EB] rounded-[20px] p-[16px]">
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-[16px]">
            {[
              ...
              <div
                key={index}
                className="bg-[#FEFFFA] rounded-[16px] p-[24px] md:p-[32px] h-auto xl:h-[244px] flex flex-col"
              >
