    ...
    <section className="container-px max-w-7xl mx-auto mt-24 md:mt-32 overflow-hidden">
      ...
      <div ref={ref} className="mt-10 rounded-[20px] bg-[#eff0eb] p-4 grid xl:grid-cols-5 gap-4">
        ...
        <motion.div
          ...
          className="xl:col-span-3 bg-[#fefffa] rounded-[16px] p-4 xl:p-10 flex flex-col justify-between h-auto min-h-[240px] lg:min-h-[180px] xl:min-h-[320px] xl:min-h-0 xl:h-[552px]"
        >
